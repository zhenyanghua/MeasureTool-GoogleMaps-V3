...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__text__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_touch__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touches__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_cross__ = __webpack_require__(72);
/* unused harmony reexport cross */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_descending__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_histogram__ = __webpack_require__(74);
/* unused harmony reexport histogram */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_threshold_freedmanDiaconis__ = __webpack_require__(84);
/* unused harmony reexport thresholdFreedmanDiaconis */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_threshold_scott__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_max__ = __webpack_require__(76);
/* unused harmony reexport max */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_mean__ = __webpack_require__(77);
/* unused harmony reexport mean */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_median__ = __webpack_require__(78);
/* unused harmony reexport median */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_merge__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_permute__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_scan__ = __webpack_require__(81);
/* unused harmony reexport scan */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__src_shuffle__ = __webpack_require__(82);
/* unused harmony reexport shuffle */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_sum__ = __webpack_require__(83);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_zip__ = __webpack_require__(86);
...
var _contextMenu = __webpack_require__(153);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_drag__ = __webpack_require__(90);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_dispatch__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constant__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__event__ = __webpack_require__(91);
...
var _projectionUtility = __webpack_require__(65);

var _projectionUtility2 = _interopRequireDefault(_projectionUtility);

var _d3Geo = __webpack_require__(67);

var _geometry = __webpack_require__(64);

var _d3Drag = __webpack_require__(66);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _onAddOverlay() {
      ...
      this._hoverCircle.append("circle").style('fill', 'rgb(252, 252, 252)').style('stroke', 'rgb(100, 100, 100)').style('stroke-width', '2.5px').style('pointer-events', 'none').attr('r', 5);
    }
    ...
    value: function _updateCircles() {
      ...
      var self = this;
      // join with old data
      var circles = this._nodeCircles.selectAll("circle").data(this._geometry ? this._geometry.nodes : []).attr('class', 'cover-circle').style('fill', 'white').style('stroke', 'black').style('stroke-width', '2.5px').attr('r', 5).attr('cx', function (d) {
    ...
    value: function _updatePath() {
      ...
      var pathTick = this._pathTick.selectAll("path").data(this._geometry ? this._geometry.paths : []).style('fill', 'none').style('stroke', 'transparent').style('stroke-width', '8px').attr('d', gmPath).on('mousemove', function (d) {
        ...
        var point = self._projectionUtility.latLngToSvgPoint(_helper2.default.getPointOnPath(self._projectionUtility.svgPointToLatLng([_d3Selection.event.offsetX, _d3Selection.event.offsetY]), self._pathsSegments));
        self._hoverCircle.select("circle").attr('cx', point[0]).attr('cy', point[1]);
      }).on('mouseout', function (d) {
        self._hoverCircle.select("circle").attr('cx', null).attr('cy', null);
      });
