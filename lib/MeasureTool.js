...
var Helper = function () {
  ...
  _createClass(Helper, null, [{
    ...
    value: function getlengthBetween(p1, p2) {
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _updateText() {
      ...
      var text = this._text.selectAll("text").data(this._geometry ? this._geometry.lines : []).attr('class', 'measure-text').attr('text-anchor', 'middle').attr('dominant-baseline', 'text-after-edge').attr('transform', function (d, i) {
      ...
      text.enter().append('text').attr('class', 'measure-text').attr('text-anchor', 'middle').attr('dominant-baseline', 'text-after-edge').attr('transform', function (d, i) {
        var p1 = _this5._projectionUtility.latLngToSvgPoint(d[0]);
        var p2 = _this5._projectionUtility.latLngToSvgPoint(d[1]);
        return _this5._doTextTransform(p1, p2);
      }).text(function (d, i) {
