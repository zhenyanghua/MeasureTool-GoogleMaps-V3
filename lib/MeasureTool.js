...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__select__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectAll__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__enter__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__exit__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__merge__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__order__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sort__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__call__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__nodes__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__node__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__size__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__empty__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__each__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__attr__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__style__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__property__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__classed__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__text__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__html__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__raise__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__lower__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__append__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__insert__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__remove__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__datum__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__on__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__dispatch__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_local__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_matcher__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_mouse__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_select__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_selectAll__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_selectorAll__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_touch__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touches__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__noevent__ = __webpack_require__(13);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_drag__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_nodrag__ = __webpack_require__(12);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dispatch__ = __webpack_require__(28);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_dispatch__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_selection__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nodrag__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__noevent__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constant__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__event__ = __webpack_require__(31);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectorAll__ = __webpack_require__(17);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _onAddOverlay() {
      ...
      this._text = this._svgOverlay.append('g').attr('class', 'text-group');
      this._text.selectAll('text').data(this._geometry ? this._geometry.lines : []);
    ...
    value: function _updateText() {
      ...
      var text = this._text.selectAll("text").data(this._geometry ? this._geometry.lines : []).attr('class', 'measure-text').attr('text-anchor', 'middle').attr('dominant-baseline', 'text-after-edge').attr('transform', function (d) {
        ...
        return _helper2.default.computelengthBetween(d[0], d[1]);
      });

      text.enter().append('text').attr('class', 'measure-text').attr('text-anchor', 'middle').attr('dominant-baseline', 'text-after-edge').attr('transform', function (d) {
        var p1 = _this5._projectionUtility.latLngToSvgPoint(d[0]);
        var p2 = _this5._projectionUtility.latLngToSvgPoint(d[1]);
        return _this5._doTextTransform(p1, p2);
      }).text(function (d, i) {
    ...
    value: function _onDragLine() {
      ...
      var lineDrag = (0, _d3Drag.drag)().on('drag', function (d, i) {
        if (!isDragged) {
          isDragged = true;
          _this6._geometry.insertNode(i + 1, _this6._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
          _this6._updateLine();
          _this6._updateText();
        }
        _this6._updateHoverCirclePosition(_d3Selection.event.x, _d3Selection.event.y);
        _this6._updateLinePosition(_this6._linesBase, i + 1);
        _this6._updateLinePosition(_this6._linesAux, i + 1);
        _this6._updateTextPosition(i + 1);
      });

      lineDrag.on('start', function () {
        _d3Selection.event.sourceEvent.stopPropagation();
        _this6._hoverCircle.select("circle").attr('class', "cover-circle");
        _this6._disableMapScroll();
      });

      lineDrag.on('end', function (d, i) {
        _this6._enableMapScroll();
        if (isDragged) {
          _this6._geometry.updateNode(i + 1, _this6._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
          _this6._hideHoverCircle();
          _this6._overlay.draw();
          isDragged = false;
        }
        _this6._hoverCircle.select("circle").attr('class', "grey-circle");
      });
    ...
    value: function _updateTextPosition(i) {
      var _this7 = this;

      if (i < this._geometry.lines.length) {
        this._text.select('text:nth-child(' + (i + 1) + ')').attr('transform', function (d) {
          var p1 = [_d3Selection.event.x, _d3Selection.event.y];
          var p2 = _this7._projectionUtility.latLngToSvgPoint(d[1]);
          return _this7._doTextTransform(p1, p2);
        }).text(function (d, i) {
          return _helper2.default.computelengthBetween(_this7._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]), d[1]);
        });
      }
      if (i > 0) {
        this._text.select('text:nth-child(' + i + ')').attr('transform', function (d) {
          var p1 = _this7._projectionUtility.latLngToSvgPoint(d[0]);
          var p2 = [_d3Selection.event.x, _d3Selection.event.y];
          return _this7._doTextTransform(p1, p2);
        }).text(function (d, i) {
          return _helper2.default.computelengthBetween(d[0], _this7._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
        });
      }
    }
  }, {
