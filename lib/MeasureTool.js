...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _updateCircles() {
      ...
      var self = this;
      // join with old data
      var circles = this._svgOverlay.selectAll("circle").data(this._geometry ? this._geometry.nodes : []);
    ...
    value: function _onDragCircle() {
      ...
      var circleDrag = (0, _d3Drag.drag)().on('drag', function (d) {
        ...
        (0, _d3Selection.select)(this).attr('cx', d.x = _d3Selection.event.x).attr('cy', d.y = _d3Selection.event.y);
      ...
      circleDrag.on('end', function (d, i) {
        if (!isDragged) {
          ...
          (0, _d3Selection.select)(this).attr('class', 'removed-circle');
        } else {
