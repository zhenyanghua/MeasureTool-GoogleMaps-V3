...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _onAddOverlay() {
      ...
      this._text = this._svgOverlay.append('g').attr('class', 'measure-text');
    ...
    value: function _updateLine() {
      ...
      linesBase.enter().append('line').attr('id', function (d, i) {
        return 'text_' + i;
      }).attr("class", "base-line").attr('x1', function (d) {
        return _this4._projectionUtility.latLngToSvgPoint(d[0])[0];
      }).attr('y1', function (d) {
        return _this4._projectionUtility.latLngToSvgPoint(d[0])[1];
      }).attr('x2', function (d) {
    ...
    value: function _updateText() {
      ...
      var text = this._text.selectAll("text").data(this._geometry ? this._geometry.lines : []).enter().append('text').style("stroke", "red").attr('text-anchor', 'middle').attr('transform', function (d, i) {
