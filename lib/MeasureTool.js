...
var _geometry = __webpack_require__(147);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _onDrawOverlay() {
      ...
      var circle = this._svgOverlay.selectAll('circle').data(this._geometry ? this._geometry.jsonNode : []).attr('class', 'cover-circle').style('fill', 'white').style('stroke', 'black').style('stroke-width', '2.5px').attr('r', 5).attr('cx', function (d) {
