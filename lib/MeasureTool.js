...
var _helper = __webpack_require__(155);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _onAddOverlay() {
      ...
      this._svgOverlay.selectAll("path").data(this._geometry ? this._geometry.path : []);
    ...
    value: function _updatePath() {
      ...
      var path = this._svgOverlay.selectAll("path").data(this._geometry ? this._geometry.paths : []).style('fill', 'none').style('stroke', 'black').style('stroke-width', '2.5px').attr('d', gmPath);
