...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _updateArea(i) {
      ...
      if (n > 2) {
        if (i === 0) {
          offset = this._helper.computeLengthBetween(this._geometry.nodes[n - 1], this._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
          ...
          var point = _d3Selection.event ? this._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]) : this._geometry.nodes[i];
          offset = this._helper.computeLengthBetween(point, this._geometry.nodes[0]);
