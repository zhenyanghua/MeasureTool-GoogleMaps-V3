...
var Helper = function () {
  ...
  _createClass(Helper, null, [{
    ...
    value: function _interpolate(p1, p2, fraction) {
      return google.maps.geometry.spherical.interpolate(new google.maps.LatLng(p1[1], p1[0]), new google.maps.LatLng(p2[1], p2[0]), fraction);
    }
  }]);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _onAddOverlay() {
      ...
      this._pathBase.selectAll("path").data(this._geometry ? this._geometry.path : []);

      this._pathAux = this._svgOverlay.append('g').attr('class', 'aux');
      this._pathAux.selectAll("path").data(this._geometry ? this._geometry.path : []);

      this._ticks = this._svgOverlay.append('g').attr('class', 'ticks');
      this._ticks.selectAll("marker").data();
    ...
    value: function _onDragCircle() {
      ...
      var circleDrag = (0, _d3Drag.drag)().on('drag', function (d) {
        isDragged = true;
        ...
        // svg path coords.
        var gmPath = (0, _d3Geo.geoPath)().projection(gmTransform);
        self._svgOverlay.selectAll("path").attr('d', gmPath);
      });
    ...
    value: function _onDragPath() {
      ...
      var self = this;
      var isDragged = false;
      var pathDrag = (0, _d3Drag.drag)().on('drag', function (d) {
        if (!isDragged) {
          isDragged = true;
          ...
          _this4._svgOverlay.selectAll("path").data(_this4._geometry ? _this4._geometry.paths : []);
        }
        ...
        var gmPath = (0, _d3Geo.geoPath)().projection(gmTransform);
        // update path
        _this4._svgOverlay.selectAll("path").attr('d', gmPath);
      });
